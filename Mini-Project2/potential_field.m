...
for k=1:steps
    ...
    %deltaq = deltaq + (rand(2,1)-0.5)*2*.1;
...
fprintf('The time it takes the robot to find the goal for the Potential Field Algorithm is %.2f\n',...
    tfinal)
fprintf('The path length is %.2f\n',len);
